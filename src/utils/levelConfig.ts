...
export const LEVELS: LevelProfile[] = [
    ...
    { level: 1, description: 'Beginner I (~200 Elo)', animalName: 'Chick', slogan: 'Peep peep! I\'m just learning too! 🐣',
    ...
    { level: 2, description: 'Beginner II (~300 Elo)', animalName: 'Mouse', slogan: 'Squeak! I\'m getting better at this! 🐭',
    ...
    { level: 3, description: 'Beginner III (~400 Elo)', animalName: 'Rabbit', slogan: 'Hop hop! I\'m quick but still learning! 🐰',
    ...
    { level: 4, description: 'Beginner IV (~500 Elo)', animalName: 'Fox', slogan: 'Cunning moves ahead! Watch out! 🦊',
    ...
    { level: 5, description: 'Novice I (~600 Elo)', animalName: 'Dog', slogan: 'Woof! I\'m loyal but getting stronger! 🐕',
    ...
    { level: 6, description: 'Novice II (~700 Elo)', animalName: 'Goat', slogan: 'Baa! I climb higher every game! 🐐',
    ...
    { level: 7, description: 'Intermediate I (~800 Elo)', animalName: 'Sheep', slogan: 'Baa! I\'m not as fluffy as I look! 🐑',
    ...
    { level: 8, description: 'Intermediate II (~900 Elo)', animalName: 'Pig', slogan: 'Oink! I\'m smarter than you think! 🐷',
    ...
    { level: 9, description: 'Intermediate III (~1000 Elo)', animalName: 'Deer', slogan: 'Graceful but dangerous! Watch my moves! 🦌',
    ...
    { level: 10, description: 'Skilled I (~1100 Elo)', animalName: 'Boar', slogan: 'Grunt! I charge forward with power! 🐗',
    ...
    { level: 11, description: 'Skilled II (~1200 Elo)', animalName: 'Leopard', slogan: 'Stealthy and swift! Prepare yourself! 🐆',
    ...
    { level: 12, description: 'Advanced (~1300 Elo)', animalName: 'Panther', slogan: 'Silent but deadly! Are you ready? 🐆',
    ...
    { level: 13, description: 'Club Beginner (~1400 Elo)', animalName: 'Tiger', slogan: 'Rawr! I\'m fierce and getting stronger! 🐅',
      play: { kind: 'elo', uciElo: 1400, timeMs: 2000 } },
  
    { level: 14, description: 'Club Novice (~1500 Elo)', animalName: 'Lion', slogan: 'King of the board! Bow before me! 🦁',
      play: { kind: 'elo', uciElo: 1500, timeMs: 2500 } },
  
    { level: 15, description: 'Club Intermediate (~1600 Elo)', animalName: 'Horse', slogan: 'Galloping towards victory! Neigh! 🐎',
      play: { kind: 'elo', uciElo: 1600, timeMs: 3000 } },
  
    { level: 16, description: 'Strong Club (~1700 Elo)', animalName: 'Buffalo', slogan: 'Mighty and unstoppable! Charge! 🐃',
      play: { kind: 'elo', uciElo: 1700, timeMs: 3500 } },
  
    { level: 17, description: 'Expert (~1800 Elo)', animalName: 'Rhino', slogan: 'Thick-skinned and powerful! Grunt! 🦏',
      play: { kind: 'elo', uciElo: 1800, timeMs: 4000 } },
  
    { level: 18, description: 'Candidate Master (~1900 Elo)', animalName: 'Hippo', slogan: 'Massive and strategic! Watch out! 🦛',
      play: { kind: 'elo', uciElo: 1900, timeMs: 4500 } },
  
    { level: 19, description: 'Master (~2000 Elo)', animalName: 'Giraffe', slogan: 'Towering intellect! I see all! 🦒',
      play: { kind: 'elo', uciElo: 2000, timeMs: 5000 } },
  
    { level: 20, description: 'Strong Master (~2100+ Elo)', animalName: 'Elephant', slogan: 'Ancient wisdom and power! Tremble! 🐘',
